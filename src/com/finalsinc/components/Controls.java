//This will be edited for numberpad use

package com.finalsinc.components;

import com.finalsinc.arithmattackgame.R;
import com.finalsinc.activities.GameActivity;
	...
	// flag values
		...
		public void show(final Activity a, final String promptString, int inFlags, 
		  final numPadInterface postrun) {
			...
			btnE = (Button) iView.findViewById(R.id.enter);
